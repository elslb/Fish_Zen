...
public class Fish_Zen extends PApplet {
...
public void draw() 
{
  ...
  noStroke();
  fill(230,230,230,mouseY/2-35-60*sin(frameCount*0.05f));
  ellipse(50,30,sin(frameCount*0.03f)*3,12);
  ellipse(50,30,12,sin(frameCount*0.03f)*3);
  ellipse(330,190,sin(frameCount*0.03f)*3,10);
  ellipse(330,190,10,sin(frameCount*0.03f)*3);
  ellipse(90,200,sin(frameCount*0.03f)*3,4);
  ellipse(90,200,4,sin(frameCount*0.03f)*3);
  
  fill(230,230,230,mouseY/2-30-90*sin(frameCount*0.01f));
  ellipse(340,90,sin(frameCount*0.01f)*2,5);
  ellipse(340,90,5,sin(frameCount*0.01f)*2);
  ellipse(180,10,sin(frameCount*0.01f)*2,14);
  ellipse(180,10,14,sin(frameCount*0.01f)*2);
  ellipse(30,95,sin(frameCount*0.01f)*2,9);
  ellipse(30,95,9,sin(frameCount*0.01f)*2);
  
  fill(230,230,230,mouseY/2-30-70*sin(frameCount*0.03f));
  ellipse(50,180,sin(frameCount*0.02f)*2,8);
  ellipse(50,180,8,sin(frameCount*0.02f)*2);
  ellipse(110,80,sin(frameCount*0.02f)*2,3);
  ellipse(110,80,3,sin(frameCount*0.02f)*2);
  ellipse(300,80,sin(frameCount*0.02f)*2,13);
  ellipse(300,80,13,sin(frameCount*0.02f)*2);
  ...
  noStroke();
  fill(255,100);
  rect(210+(pmouseX*0.5f),10,20,20,15);
  rect(250+(pmouseX*0.5f),40,20,10,40);
  fill(255,110);
  rect(220+(pmouseX*0.5f),20,50,20,12);

  //Cloud Cluster 3
  //These clouds are in the middle so a 0.7 multiplier is used
  noStroke();
  fill(255,110);
  rect(310+(pmouseX*0.7f),110,70,30,15);
  fill(255,90);
  rect(370+(pmouseX*0.7f),120,20,20,12);
  rect(340+(pmouseX*0.7f),90,40,30,15);
  fill(255,95);
  rect(300+(pmouseX*0.7f),130,50,20,12);
  ...
  fill(0xffa7e7f0);
  ellipse(
  (float)(89+Math.sin(frameCount*.03f-.05f)*8),
  (float)(222+Math.cos(frameCount*.06f-.09f)*8),
  28, 28);
  //right hand
  ellipse(
  (float)(317+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(221+Math.cos(frameCount*.06f-.09f)*8),
  28, 28);
  //fingers
  beginShape(LINES);
  stroke(0xffa7e7f0);
  ...
  //left hand fingers
  vertex(
  (float)(85+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(214+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(66+Math.sin(frameCount*.03f-.05f)*8),
  (float)(217+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(94+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(231+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(82+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(239+Math.cos(frameCount*.06f-.09f)*8));
  //right hand fingers
  vertex(
  (float)(315+Math.sin(frameCount*.03f-.05f)*8),
  (float)(214+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(338+Math.sin(frameCount*.03f-.05f)*8),
  (float)(217+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(306+Math.sin(frameCount*.03f-.05f)*8),
  (float)(231+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(318+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(239+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  fill(0xff4f6a9e);
  ellipse(
  (float)(160+Math.sin(frameCount*.03f-.05f)*8),
  (float)(290+Math.cos(frameCount*.06f-.09f)*8),
  90, 50);
  ellipse(
  (float)(240+Math.sin(frameCount*.03f-.05f)*8),
  (float)(290+Math.cos(frameCount*.06f-.09f)*8),
  90, 50);
  ...
  fill(0xff8599cb);
  ellipse(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(207+Math.cos(frameCount*.06f-.09f)*8), 
  115, 144);
  ...
  ellipse(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8),
  (float)(266+Math.cos(frameCount*.06f-.09f)*8), 
  90, 110);
  //legs
  ellipse(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8),
  (float)(262+Math.cos(frameCount*.06f-.09f)*8), 
  190, 80);
  ...
  vertex(
  (float)(159+Math.sin(frameCount*.03f-.05f)*8),
  (float)(156+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(130+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(194+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(158+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(221+Math.cos(frameCount*.06f-.09f)*8));
  //right top half arm
  vertex(
  (float)(241+Math.sin(frameCount*.03f-.05f)*8),
  (float)(156+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(270+Math.sin(frameCount*.03f-.05f)*8),
  (float)(194+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(242+Math.sin(frameCount*.03f-.05f)*8),
  (float)(221+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  fill(0xff4f6a9e);
  triangle(
  (float)(181+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(148+Math.cos(frameCount*.06f-.09f)*8), 
  (float)(219+Math.sin(frameCount*.03f-.05f)*8),
  (float)(148+Math.cos(frameCount*.06f-.09f)*8), 
  (float)(200+Math.sin(frameCount*.03f-.05f)*8),
  (float)(173+Math.cos(frameCount*.06f-.09f)*8));
  beginShape(LINES);
  stroke(0xff8a89c4);
  vertex(
  (float)(179+Math.sin(frameCount*.03f-.05f)*8),
  (float)(148+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(202+Math.sin(frameCount*.03f-.05f)*8),
  (float)(173+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(219+Math.sin(frameCount*.03f-.05f)*8),
  (float)(150+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(202+Math.sin(frameCount*.03f-.05f)*8),
  (float)(173+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  stroke(0xff5877b8);
  vertex(
  (float)(173+Math.sin(frameCount*.03f-.05f)*8),
  (float)(148+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(213+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(190+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(228+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(145+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(202+Math.sin(frameCount*.03f-.05f)*8),
  (float)(178+Math.cos(frameCount*.06f-.09f)*8));

  vertex(
  (float)(159+Math.sin(frameCount*.03f-.05f)*8),
  (float)(159+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8),
  (float)(200+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(239+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(156+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(213+Math.sin(frameCount*.03f-.05f)*8),
  (float)(190+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(241+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(158+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(216+Math.sin(frameCount*.03f-.05f)*8),
  (float)(192+Math.cos(frameCount*.06f-.09f)*8));
  endShape();

  noFill();
  arc(
  (float)(181+Math.sin(frameCount*.03f-.05f)*8),
  (float)(214+Math.cos(frameCount*.06f-.09f)*8), 50,
  40, PI+HALF_PI+QUARTER_PI, TWO_PI+HALF_PI);
  arc(
  (float)(196+Math.sin(frameCount*.03f-.05f)*8),
  (float)(205+Math.cos(frameCount*.06f-.09f)*8),
  50,40, PI+HALF_PI+QUARTER_PI, TWO_PI+HALF_PI);
  
  //shadow on the body
  noStroke();
  fill(78,144,113,95-mouseY/2.5f);
  ellipseMode(CENTER);
  ellipse(
  (float)(200+Math.sin(frameCount*.03f-.04f)*8),
  (float)(220+Math.cos(frameCount*.06f-.09f)*8),
  100,20);
  ...
  arc(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8),
  (float)(140+Math.cos(frameCount*.06f-.09f)*8), 
  ...
  vertex(
  (float)(134+Math.sin(frameCount*.03f-.05f)*8),
  (float)(190+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(80+Math.sin(frameCount*.03f-.05f)*8),
  (float)(210+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(139+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(290+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(150+Math.sin(frameCount*.03f-.05f)*8),
  (float)(200+Math.cos(frameCount*.06f-.09f)*8));
  //right bottom half arm
  vertex(
  (float)(266+Math.sin(frameCount*.03f-.05f)*8),
  (float)(190+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(328+Math.sin(frameCount*.03f-.05f)*8),
  (float)(210+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(261+Math.sin(frameCount*.03f-.05f)*8),
  (float)(290+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(250+Math.sin(frameCount*.03f-.05f)*8),
  (float)(200+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  stroke(0xff5877b8);
  vertex(
  (float)(149+Math.sin(frameCount*.03f-.05f)*8),
  (float)(199+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(146+Math.sin(frameCount*.03f-.05f)*8),
  (float)(231+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(254+Math.sin(frameCount*.03f-.05f)*8),
  (float)(231+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(251+Math.sin(frameCount*.03f-.05f)*8),
  (float)(199+Math.cos(frameCount*.06f-.09f)*8));
  ...
  beginShape(TRIANGLES);
  vertex(
  (float)(123+Math.sin(frameCount*.03f-.05f)*8),
  (float)(85+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(125+Math.sin(frameCount*.03f-.05f)*8),
  (float)(134+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(170+Math.sin(frameCount*.03f-.05f)*8),
  (float)(110+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(272+Math.sin(frameCount*.03f-.05f)*8),
  (float)(82+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(269+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(134+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(224+Math.sin(frameCount*.03f-.05f)*8),
  (float)(108+Math.cos(frameCount*.06f-.09f)*8));
  endShape();

  ellipseMode(CENTER);  //Set ellipseMode to CENTER
  fill(0xffa7e7f0);  //Set fill to light blue colour
  ellipse(
  (float)(125+Math.sin(frameCount*.03f-.05f)*8),
  (float)(109+Math.cos(frameCount*.06f-.09f)*8),
  14, 46);
  ellipse(
  (float)(271+Math.sin(frameCount*.03f-.05f)*8),
  (float)(109+Math.cos(frameCount*.06f-.09f)*8), 
  12, 52);
  ...
  stroke(0xff668cb9);
  vertex(
  (float)(124+Math.sin(frameCount*.03f-.05f)*8),
  (float)(95+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(142+Math.sin(frameCount*.03f-.05f)*8),
  (float)(99+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(123+Math.sin(frameCount*.03f-.05f)*8),
  (float)(105+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(142+Math.sin(frameCount*.03f-.05f)*8),
  (float)(105+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(124+Math.sin(frameCount*.03f-.05f)*8),
  (float)(115+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(143+Math.sin(frameCount*.03f-.05f)*8),
  (float)(111+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(127+Math.sin(frameCount*.03f-.05f)*8),
  (float)(125+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(144+Math.sin(frameCount*.03f-.05f)*8),
  (float)(116+Math.cos(frameCount*.06f-.09f)*8));

  //right fin
  vertex(
  (float)(253+Math.sin(frameCount*.03f-.05f)*8),
  (float)(102+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(268+Math.sin(frameCount*.03f-.05f)*8),
  (float)(92+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(255+Math.sin(frameCount*.03f-.05f)*8),
  (float)(108+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(269+Math.sin(frameCount*.03f-.05f)*8),
  (float)(103+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(253+Math.sin(frameCount*.03f-.05f)*8),
  (float)(112+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(269+Math.sin(frameCount*.03f-.05f)*8),
  (float)(113+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(252+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(117+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(267+Math.sin(frameCount*.03f-.05f)*8),
  (float)(124+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  noStroke();
  ellipseMode(CENTER);  //Set ellipseMode to CENTER
  fill(0xffa7e7f0);  //Set fill to light clue colour
  ellipse(
  (float)(200+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(98+Math.cos(frameCount*.06f-.09f)*8), 
  125, 116);
  ...
  ellipseMode(CENTER);
  arc(
  (float)(172+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(100+Math.cos(frameCount*.06f-.09f)*8), 
  24, 12, 0, PI);
  arc(
  (float)(226+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(100+Math.cos(frameCount*.06f-.09f)*8), 
  24, 12, 0, PI);
  beginShape(LINES);
  vertex(
  (float)(182+Math.sin(frameCount*.03f-.05f)*8),
  (float)(92+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(181+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(91+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(215+Math.sin(frameCount*.03f-.05f)*8),
  (float)(92+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(216+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(91+Math.cos(frameCount*.06f-.09f)*8));
  ...
  strokeWeight(3);
  vertex(
  (float)(194+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(113+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(193+Math.sin(frameCount*.03f-.05f)*8), 
  (float)(112+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(205+Math.sin(frameCount*.03f-.05f)*8),
  (float)(112+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(204+Math.sin(frameCount*.03f-.05f)*8),
  (float)(113+Math.cos(frameCount*.06f-.09f)*8));
  ...
  vertex(
  (float)(173+Math.sin(frameCount*.03f-.05f)*8),
  (float)(75+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(177+Math.sin(frameCount*.03f-.05f)*8),
  (float)(79+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(222+Math.sin(frameCount*.03f-.05f)*8),
  (float)(75+Math.cos(frameCount*.06f-.09f)*8));
  vertex(
  (float)(218+Math.sin(frameCount*.03f-.05f)*8),
  (float)(79+Math.cos(frameCount*.06f-.09f)*8));
  endShape();
  ...
  rect(
  (float)(172+Math.sin(frameCount*.03f-.05f)*8),
  (float)(123+Math.cos(frameCount*.06f-.09f)*8),
  54, 12, 40);
  line(
  (float)(178+Math.sin(frameCount*.03f-.05f)*8),
  (float)(129+Math.cos(frameCount*.06f-.09f)*8),
  (float)(220+Math.sin(frameCount*.03f-.05f)*8),
  (float)(129+Math.cos(frameCount*.06f-.09f)*8));
  ellipseMode(CENTER);
  noFill();
  arc(
  ...
  fill(0xfff3f0fa);
  ellipse(
  (float)(198+Math.sin(frameCount*.03f-.05f)*8),
  (float)(58+Math.cos(frameCount*.06f-.09f)*8),
  30,16);
  //pupil
  //moves with the mouse
  fill(0xff171721);
  ellipse(
  (float)(194+mouseX*0.02f+Math.sin(frameCount*.03f-.05f)*8),
  (float)(56+mouseY*0.015f+Math.cos(frameCount*.06f-.09f)*8)
  , 15, 8);
  stroke(0xfff3f0fa);
  strokeWeight(5);
  point(
  (float)(191+mouseX*0.02f+Math.sin(frameCount*.03f-.05f)*8),
  (float)(54+mouseY*0.015f+Math.cos(frameCount*.06f-.09f)*8));
...
public void mousePressed()                                       
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Fish_Zen" };
    if (passedArgs != null) {
